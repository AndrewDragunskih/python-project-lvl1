...
def main():
    ...
    while (current_attempt_num <= attempts_count) and (is_user_answer_right == True): 
        ...
        if answer == right_answer:  #check user answer
            ...
            print(answer,'is wrong answer ;(. Correct answer was', right_answer, sep=' ')
            print("Let's try again,", user_name, end = '!\n')
            
    if is_user_answer_right == True:
